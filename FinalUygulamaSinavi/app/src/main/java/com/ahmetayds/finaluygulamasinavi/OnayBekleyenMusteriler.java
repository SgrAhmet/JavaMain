...
public class OnayBekleyenMusteriler extends AppCompatActivity {

    ListView onayBekleyenList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onay_bekleyen_musteriler);

        onayBekleyenList = findViewById(R.id.onayBekleyenList);
        ...
        try {
            ...
            onayBekleyenList.setAdapter(arrayAdapter);
        ...
        onayBekleyenList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent sayfayaGit = new Intent(OnayBekleyenMusteriler.this, OnayBekleyenDetay.class);
